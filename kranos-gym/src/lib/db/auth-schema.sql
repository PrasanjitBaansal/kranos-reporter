...
-- ============================================================================
-- TRIGGERS for Automatic Updates (Created after all tables exist)
-- ============================================================================
...
BEGIN
    ...
    INSERT INTO security_events (event_type, user_id, username, details)
    VALUES ('user_created', NEW.id, NEW.username,
...
BEGIN
    ...
    INSERT INTO security_events (event_type, user_id, username, details)
    VALUES ('password_changed', NEW.id, NEW.username,
...
-- ============================================================================
-- INDEXES for Performance Optimization (Created after all tables exist)
-- ============================================================================
